...
namespace StudentPlatform.Controllers
{
    ...
    public class StudentCoursesController : ControllerBase
    {
        ...
        public StudentCoursesController(StudentPlatformContext context)
        {
            _context = context;
        }
        ...
        [HttpDelete]
        public async Task<ActionResult<StudentCourse>> DeleteStudentCourse(StudentCourse studentCourse)
        {
            var studentCourseToDelete = await _context.StudentCourses
                .FindAsync(studentCourse.StudentId, studentCourse.CourseId);
            ...
            _context.StudentCourses.Remove(studentCourseToDelete);
            await _context.SaveChangesAsync();

            return studentCourseToDelete;
        }
